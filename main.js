...
let editElement;// düzzenleme yapılan öğeyi temsil eder
let editFlag = false; // düzenleme modunda olup olmadığını belirtir
let editID = '';

//form gçnderildiğinde addıtem fonk çağır
form.addEventListener('submit', addItem);
// temizle düğmesine tıklanıldığında clearItems fonksiuyonunu çağır
...
function addItem(e) {
    e.preventDefault();
    const value = grocery.value; //ınputun giriş değerini al
...
function editItem(e) {
    ...
    // düzenlemek istediğin elemanın revize edilmesi yenisinin işlenmesi..
